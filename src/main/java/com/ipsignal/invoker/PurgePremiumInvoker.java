...
public abstract class PurgePremiumInvoker extends EJB3InvokerJob implements Job {
	
	protected static final String INITIAL_CONTEXT_VALUE = "org.apache.openejb.client.LocalInitialContextFactory";
	protected static final String EJB_JNDI_NAME_VALUE = "PurgePremiumJobImplLocal";
