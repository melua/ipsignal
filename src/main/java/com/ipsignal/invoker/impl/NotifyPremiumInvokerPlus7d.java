...
import com.ipsignal.invoker.NotifyPremiumInvoker;

public class NotifyPremiumInvokerPlus7d extends NotifyPremiumInvoker {
	...
	public void execute(JobExecutionContext jobExecutionContext) throws JobExecutionException {
		...
		dataMap.put(EJB_ARGS_KEY, new Object[]{-7});
