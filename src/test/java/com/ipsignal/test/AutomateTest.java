...
public class AutomateTest {
	...
	public void testLatency() {
		...
		Automate automate = new AutomateMock(2000, 45, null, null);
	...
	public void testTimeout() {
		...
		Automate automate = new AutomateMock(2000, 30, null, AutomateMock.Exception.SOCKET_TIMEOUT_EXCEPTION);
		LogEntity log = automate.execute(signal, false);
		Assert.assertNotNull(log);
	...
	public void testUnknownHost() {
		...
		Automate automate = new AutomateMock(2000, 30, null, null);
		LogEntity log = automate.execute(signal, false);
		Assert.assertNotNull(log);
	...
	public void testSsl() {
		SignalEntity signal = new SignalEntity(null, null, true, "https://localhost", Browser.CHROME.toString(), 30, 15, "//*", "/.*/", null, 720, 3);
		Automate automate = new AutomateMock(2000, 7, null, null);
		LogEntity log = automate.execute(signal, false);
		Assert.assertNotNull(log);
